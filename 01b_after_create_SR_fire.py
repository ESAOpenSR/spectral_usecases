...
def plot_lr_sr(low_resolution,super_resolution):
  ...
  plt.tight_layout()
  plt.savefig("lr_sr_comparison.png")


LATITUDE = 34.07809695137825
...
save_tensor_as_geotiff(low_resolution, da[IMAGE_INDEX].attrs, out_path="data_fire/raster_data/lr_after.tif", super_resolved=False)
save_tensor_as_geotiff(super_resolution, da[IMAGE_INDEX].attrs, out_path="data_fire/raster_data/sr_after.tif", super_resolved=True)